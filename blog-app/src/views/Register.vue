<template>
  <div id="register" v-title data-title="註冊 - 程式碼戲團">
    ...
    <div class="me-login-box me-login-box-radius">
      ...
      <el-form ref="userForm" :model="userForm" :rules="rules">
        ...
        <el-form-item prop="nickname">
          <el-input placeholder="暱稱" v-model="userForm.nickname"></el-input>
        </el-form-item>
        ...
        <el-form-item size="small" class="me-login-button">
          <el-button type="primary" @click.native.prevent="register('userForm')">註冊</el-button>
        </el-form-item>
      </el-form>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            that.$store.dispatch('register', that.userForm).then(() => {
              that.$message({message: '註冊成功 快寫文章吧', type: 'success', showClose: true});
